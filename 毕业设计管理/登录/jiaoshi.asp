...
<table width="1330" border="0" align="center" cellspacing="0">
  <tr>
    <td height="73"  background="../img/4.jpg"><h2 align="center" id="xinxi">教师信息</a></h2>      </td>
  </tr>
</table>
...
If Not Isempty(Request("delete")) Then
  id=Request.Form("id")
  sqlstr="delete from teacher where Cid="&id&""
  conn.Execute(sqlstr)
  sqlstr="delete from deacher where id="&id&""
  conn.Execute(sqlstr)
...
<table width="1330" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FF6600" >
  <tr align="center">
    ...
    <th width="100" height="22" bgcolor="#FFFFFF">教师所出毕业题目</th>
...
If txt_dianhua<>"" Then sqlstr=sqlstr&" and tdianhua like '%"&txt_dianhua&"%'"
...
%>
  <form name="form1" method="post" action="">
	...
	%></td>
      ...
      <td height="22" bgcolor="#FFFFFF"><%=Left(rs("tdianhua"),15)%></td>
    </tr>
  </form>
  <%
  rs.movenext  '指针向下移动
