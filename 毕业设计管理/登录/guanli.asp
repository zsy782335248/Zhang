...
<table width="1330" border="0">
  <tr>
    <td><div align="center" id="ziti">您现在所属界面为学生信息！</div></td>
  </tr>
</table>
<p>
...
<form name="form1" method="get" action="">
  <tr>
    <td height="22" align="right"><div align="right">
      <table width="1330" border="0" align="center" cellpadding="0" cellspacing="2"  background="../img/4.jpg" id="biankuang2">
        <tr>
          <td width="594" height="22"></td>
        </tr>
        <tr>
          <td height="22" align="right"><div align="right">学号： </div></td>
          <td width="730" height="22" colspan="2"><div align="left">
  ...
  <form name="form1" method="post" action="">
	...
	%></td>
      ...
      <td height="22" bgcolor="#FFFFFF"><input name="id" type="hidden" id="id" value="<%=rs("id")%>">
          <a href="xiugai1.asp?id=<%=rs("id")%>&action=view">修改</a> 
